...
class SpdkWrapper {
 public:
  ...
  virtual int TrySubmitReadCommand(void *pinned_dst, const int64_t bytes, const int64_t lba,
                                   spdk_nvme_cmd_cb func, void *ctx, int ns_id, int qp_id) = 0;
  ...
  virtual void SubmitWriteCommand(const void *pinned_src, const int64_t bytes,
                                 const int64_t lba, spdk_nvme_cmd_cb func, void *ctx, int ns_id, int qp_id) = 0;  
